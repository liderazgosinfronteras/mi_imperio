...
List<IBNegocio> crearNegocios() => [
  ...
  IBNegocio(
    ...
    costoBase: 200, ingresoBase: 1.2, nivelDesbloqueo: 1,
  ),
  IBNegocio(
    ...
    costoBase: 500, ingresoBase: 3.0, nivelDesbloqueo: 2,
  ),
  IBNegocio(
    ...
    costoBase: 1500, ingresoBase: 8.0, nivelDesbloqueo: 3,
  ),
  IBNegocio(
    ...
    costoBase: 5000, ingresoBase: 25.0, nivelDesbloqueo: 4,
  ),
  IBNegocio(
    ...
    costoBase: 15000, ingresoBase: 75.0, nivelDesbloqueo: 5,
  ),
  IBNegocio(
    ...
    costoBase: 50000, ingresoBase: 250.0, nivelDesbloqueo: 6,
  ),
  IBNegocio(
    ...
    costoBase: 150000, ingresoBase: 800.0, nivelDesbloqueo: 7,
  ),
  IBNegocio(
    ...
    costoBase: 500000, ingresoBase: 2500.0, nivelDesbloqueo: 8,
  ),
  IBNegocio(
    ...
    costoBase: 1500000, ingresoBase: 8000.0, nivelDesbloqueo: 9,
  ),
  IBNegocio(
    ...
    costoBase: 5000000, ingresoBase: 28000.0, nivelDesbloqueo: 10,
  ),
  IBNegocio(
    ...
    costoBase: 20000000, ingresoBase: 120000.0, nivelDesbloqueo: 11,
  ),
];
