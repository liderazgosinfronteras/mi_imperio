...
// ═══════════════════════════════════════════════════════════════
//  DATOS — PASIVOS / DOODADS  (24 cartas barajadas por turno)
// ═══════════════════════════════════════════════════════════════
const _pasivos = [
  // ── Gastos pequeños (vida diaria real) ──────────────────────
  CFCarta(tipo:'pasivo', emoji:'☕', titulo:'Café diario + snacks',
    descripcion:'El café de cada mañana y los snacks se sumaron: \$120 este mes.',
    leccion:'Los gastos hormiga parecen pequeños, pero en un año pueden ser miles.',
    costo:120, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'📺', titulo:'Suscripciones olvidadas',
    descripcion:'Revisaste el banco: 4 suscripciones que ya no usas. \$90/mes drenando tu cuenta.',
    leccion:'Audita tus suscripciones cada 3 meses. Lo que no usas, cancélalo.',
    costo:90, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🛵', titulo:'Delivery & comida a domicilio',
    descripcion:'Una semana de pedidos seguidos. \$200 que podrían haberse invertido.',
    leccion:'Cocinar en casa puede ahorrarte \$150+ al mes: pequeño esfuerzo, gran impacto.',
    costo:200, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🎂', titulo:'Cumpleaños del mes',
    descripcion:'Regalo, cena y decoración para tres cumpleaños este mes. \$280.',
    leccion:'Presupuesta los eventos sociales. La generosidad planificada no arruina tu flujo.',
    costo:280, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🐾', titulo:'Veterinario inesperado',
    descripcion:'Tu mascota se enfermó. Consulta y medicamentos: \$350.',
    leccion:'Las mascotas son gastos reales. Incluye un fondo de salud animal en tu presupuesto.',
    costo:350, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🔧', titulo:'Reparación del hogar',
    descripcion:'Llave que gotea, cerradura rota. Un técnico en casa: \$220.',
    leccion:'Mantener tu hogar en buen estado evita reparaciones mayores y más costosas.',
    costo:220, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🚌', titulo:'Multa de tránsito',
    descripcion:'Distracción de un momento. Multa de \$180 que no esperabas.',
    leccion:'Las multas son impuestos a la distracción. El fondo de emergencia existe para esto.',
    costo:180, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'💄', titulo:'Productos de belleza',
    descripcion:'Nueva rutina de skincare y maquillaje. \$250 de impulso.',
    leccion:'Invertir en ti está bien — pero planificado, no impulsivo.',
    costo:250, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'📚', titulo:'Cursos que no terminaste',
    descripcion:'Compraste 3 cursos online en oferta. Completaste el 10%. \$140 dormidos.',
    leccion:'La educación solo es inversión si la aplicas. Aprende una cosa a la vez.',
    costo:140, ingresoPasivo:0),
  // ── Gastos medianos (sorpresas frecuentes) ───────────────────
  CFCarta(tipo:'pasivo', emoji:'📱', titulo:'Pantalla rota del celular',
    descripcion:'Se te cayó el teléfono. Reparación urgente: \$380.',
    leccion:'Un fondo de emergencia de \$500 evita que esto sea una crisis financiera.',
    costo:380, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'👗', titulo:'Shopping emocional',
    descripcion:'Un día difícil terminó en el centro comercial. \$600 a la tarjeta.',
    leccion:'El gasto emocional es el más caro. Identifica el disparador, no el carrito.',
    costo:600, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🍕', titulo:'Salidas frecuentes con amigas',
    descripcion:'Cuatro cenas este mes. La camaradería es real, la factura también: \$500.',
    leccion:'Socializa con presupuesto. "Ronda de yo" puede costar más de lo que ganas en una semana.',
    costo:500, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🎮', titulo:'Videojuego + DLCs',
    descripcion:'Juego nuevo y tres expansiones. \$900 a la tarjeta.',
    leccion:'El entretenimiento tiene costo de oportunidad: ese capital podría generar renta.',
    costo:900, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🛋️', titulo:'Mueble que "era necesario"',
    descripcion:'Renovaste el cuarto: mueble, lámpara, cuadros. \$750 sin planificar.',
    leccion:'El hogar es para vivir, no para impresionar. Mejora con plan, no con impulso.',
    costo:750, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🏥', titulo:'Cita médica sin seguro',
    descripcion:'Gripa fuerte, análisis y medicamentos sin cobertura. \$450.',
    leccion:'El seguro médico parece un gasto hasta que lo necesitas. Entonces es una inversión.',
    costo:450, ingresoPasivo:0),
  // ── Gastos grandes (golpes inesperados) ──────────────────────
  CFCarta(tipo:'pasivo', emoji:'🚗', titulo:'Falla mecánica del auto',
    descripcion:'Transmisión averiada. El taller cobra \$1,200. No podías esperar.',
    leccion:'Los autos son pasivos que disfrazados de necesidad devoran tu cashflow.',
    costo:1200, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🏖️', titulo:'Vacaciones espontáneas',
    descripcion:'Vuelo, hotel y gastos de viaje sin presupuesto previo. \$1,800 a tarjeta.',
    leccion:'Viaja siempre — pero con un fondo de viaje separado, no con deuda.',
    costo:1800, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🏥', titulo:'Emergencia médica mayor',
    descripcion:'Urgencias y hospitalización. Sin seguro completo: \$2,500.',
    leccion:'El fondo de emergencia existe exactamente para momentos como este.',
    costo:2500, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'📦', titulo:'Inventario que no se vendió',
    descripcion:'Compraste de más esperando ventas rápidas. \$1,500 congelados.',
    leccion:'El inventario sin rotación mata el flujo de caja. Vende primero, compra después.',
    costo:1500, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🎰', titulo:'Inversión sin investigar',
    descripcion:'Entraste a un negocio que prometía retorno rápido. Perdiste \$2,000.',
    leccion:'Si parece demasiado bueno, probablemente lo es. Investiga antes de invertir.',
    costo:2000, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'✈️', titulo:'Retiro de bienestar de último minuto',
    descripcion:'Cinco días para "recargarte", sin planificarlo. \$1,600 a tarjeta.',
    leccion:'El autocuidado planificado es una inversión. El espontáneo, una deuda.',
    costo:1600, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'👜', titulo:'Bolso de lujo por impulso',
    descripcion:'Oferta "única" de bolso de marca. \$1,100 que "valía la pena".',
    leccion:'Los objetos de lujo no generan ingresos. Los activos sí. Elige sabiamente.',
    costo:1100, ingresoPasivo:0),
  CFCarta(tipo:'pasivo', emoji:'🚗', titulo:'Auto nuevo con deuda',
    descripcion:'Cambiaste el auto antes de tiempo. Cuota mensual: \$350. Deuda: \$12,000.',
    leccion:'Un auto depreciado es neutro. Uno financiado, es un pasivo que crece.',
    costo:2000, ingresoPasivo:-350),
  CFCarta(tipo:'pasivo', emoji:'🎊', titulo:'Evento social que se salió de presupuesto',
    descripcion:'La organización del evento costó \$1,400 más de lo calculado.',
    leccion:'Siempre presupuesta un 20% extra para imprevistos en cualquier evento.',
    costo:1400, ingresoPasivo:0),
];
